...
- [Night Light](docs/NIGHT_LIGHT.md): saved temperature/schedule controls and shared status; screen warming awaits Aqueous output eligibility. [Implementation plan](docs/NIGHT_MODE_IMPLEMENTATION_PLAN.md).
