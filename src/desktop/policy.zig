...
pub const Item = enum { running_apps, clipboard, launcher, workspaces, title, clock, keyboard, overview, control, audio, battery, network, bluetooth, notifications, media, tray, wallpaper };
