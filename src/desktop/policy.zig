...
pub const Item = enum { window_switcher, running_apps, clipboard, launcher, workspaces, title, clock, keyboard, overview, control, audio, battery, network, bluetooth, notifications, media, tray, wallpaper };
