...
def main():
 p=argparse.ArgumentParser(description=__doc__);p.add_argument('--source',type=Path,default=Path('/home/zoey/RiderProjects/Aqueous'));p.add_argument('--prefix',type=Path,default=ROOT/'.cache/aqueous-082');a=p.parse_args();a.source=a.source.resolve();a.prefix=a.prefix.resolve()
