...
def archive(root, output):
    ...
    paths=[]
    for name in ('build.zig','build.zig.zon','.zigversion','README.md','LICENSE','src','spikes','plugins','bindings','resources','scripts','packaging','tests','docs','themes','community-repository'):
        path=root/name
