...
| 1.0 | A complete, tested Aqueous shell | Native GTK lock UI, clipboard, screenshots, dock/taskbar, detached bar islands, integrated GTK Aqueous settings, display preview/revert, accessibility, migration, packaging and performance gates |
